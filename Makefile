...
SRC = helpers.c main.c lexer.c lexic_utils.c memory_friend.c aff_tree.c link.c data_struct.c ./builtins/cd.c ./builtins/echo.c ./builtins/env.c ./builtins/executable.c ./builtins/exit.c ./builtins/export.c ./builtins/helpers0.c ./builtins/input.c ./builtins/pipes.c ./builtins/redi.c
